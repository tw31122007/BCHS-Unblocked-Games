...
function backtopage() {
  ...
  if (type === 'apps') {
      window.location.href = '/123/apps.html';
  } else if (type === 'games') {
      window.location.href = '/123/games.html';
  } else if (type === 'credits') {
    window.location.href = '/123/credits.html';
  } else if (type === 'links') {
    window.location.href = '/123/links.html';
  } else if (type === 'info') {
    window.location.href = '/123/index.html';
  } else if (type === 'home') {
    window.location.href = '/123/home.html';
  } else if (type === 'settings') {
    window.location.href = '/123/settings.html';
  } else if (type === 'websites') {
    window.location.href = '/123/websites.html';
  } else if (type === 'vpns') {
    window.location.href = '/123/vpns.html';
  } else if (type === 'games-no-nav') {
    window.location.href = '/123/games-no-nav.html';
  } else {
