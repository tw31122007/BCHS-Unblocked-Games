...
var settingsDefaultTab = {
  ...
  icon: "/123/assets/img/favicons/google-drive-ico.ico",
};
...
function setCloak() { // applies only to premade cloaks
  ...
  switch (cloak) {
    case "search": // Google Search
      setTitle("Google");
      setFavicon("/123/assets/img/favicons/google.ico");
      location.reload();
      break;
    case "drive": // Google Drive
      setTitle("My Dive - Google Drive");
      setFavicon("/123/assets/img/favicons/google-drive-ico.ico");
      location.reload();
      break;
    case "classroom": // Google Classroom
      setTitle("Google Classroom");
      setFavicon("/123/assets/img/favicons/google-classroom.ico");
      location.reload();
      break;
    case "gmail": // Gmail
      setTitle("Gmail");
      setFavicon("/123/assets/img/favicons/gmail.ico");
      location.reload();
      break;
    case "word": // Word
      setTitle("Document.docx");
      setFavicon("/123/assets/img/favicons/word.ico");
      location.reload();
      break;
    case "powerpoint": // Powerpoint
      setTitle("Presentation.pptx");
      setFavicon("/123/assets/img/favicons/powerpoint.ico");
      location.reload();
      break;
    case "youtube": // YouTube 
      setTitle("YouTube");
      setFavicon("/123/assets/img/favicons/youtube.ico");
      location.reload();
      break;
    case "calendar": // Google Calendar
      setTitle("Google Calendar");
      setFavicon("/123/assets/img/favicons/google-calender.ico");
      location.reload();
      break;
    case "meets": // Google Meet
      setTitle("Google Meet");
      setFavicon("/123/assets/img/favicons/google-meet.ico");
      location.reload();
      break;
    case "canvas": // Canvas 
      setTitle("Canvas");
      setFavicon("/123/assets/img/favicons/canvas.ico");
      location.reload();
      break;
    case "zoom": // Zoom
      setTitle("Zoom");
      setFavicon("/123/assets/img/favicons/zoom.ico");
      location.reload();
      break;
    case "khan": // Khan Academy
      setTitle("Khan Academy"); 
      setFavicon("/123/assets/img/favicons/khan-academy.ico");
      location.reload();
      break;
  }
}
